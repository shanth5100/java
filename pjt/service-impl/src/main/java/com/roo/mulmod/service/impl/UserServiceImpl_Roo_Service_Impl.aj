...
import com.roo.mulmod.service.impl.UserServiceImpl;
...
privileged aspect UserServiceImpl_Roo_Service_Impl {
     ...
     * @return Map
     */
    public Map<String, List<MessageI18n>> UserServiceImpl.validate(User user) {
    ...
    public void UserServiceImpl.delete(User user) {
        // Clear bidirectional one-to-many parent relationship with Attachment
        for (Attachment item : user.getAttachments()) {
            item.setUzer(null);
        }
